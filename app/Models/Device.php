...
class Device extends Model
{
    ...
    /**
     * Get the DataEntryAssignment for this device's allocation point
     * This is more useful than the device-specific assignment
     */
    public function allocationPointDataEntryAssignment()
    {
        return $this->hasOneThrough(
            DataEntryAssignment::class,
            AllocationPoint::class,
            'id', // Foreign key on allocation_points table
            'allocation_point_id', // Foreign key on data_entry_assignments table
            'allocation_point_id', // Local key on devices table
            'id' // Local key on allocation_points table
        );
    }

    /**
     * Get the latest returned DataEntryAssignment for this device's allocation point
     */
    public function getReturnedDataEntryAssignment()
    {
        if (!$this->allocation_point_id) {
            return null;
        }

        return DataEntryAssignment::where('allocation_point_id', $this->allocation_point_id)
