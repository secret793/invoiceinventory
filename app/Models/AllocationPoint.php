...
class AllocationPoint extends Model
{
    ...
    /**
     * Get device retrievals associated with this allocation point
     */
    public function deviceRetrievals(): HasMany
    {
        return $this->hasMany(DeviceRetrieval::class, 'allocation_point_id');
    }
