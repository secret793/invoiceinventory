            ...
            ->action(function (array $data, $record) {
                try {
                    ...
                    $invoice = Invoice::create([
                        ...
                        'status' => 'PD', // Auto-approved as Paid
                        'approved_by' => auth()->id(),
                        'approved_at' => now(),
                    ]);
                    ...
                    // Send notification (invoice is auto-approved)
                    Notification::make()
                        ->title('Invoice auto-approved and generated successfully')
                        ->body('Invoice ' . $invoice->reference_number . ' has been automatically approved and is ready for download.')
                        ->success()
                        ->send();
                } catch (\Exception $e) {
                    DB::rollBack();
