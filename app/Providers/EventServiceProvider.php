...
use App\Observers\DataEntryAssignmentObserver;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // DataEntryAssignment Observer - Handles duplicate prevention and menu visibility
        DataEntryAssignment::observe(DataEntryAssignmentObserver::class);

        // Invoice Observer - Handles auto-approval and DeviceRetrieval status updates
