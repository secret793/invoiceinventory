            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text"
                               id="destination"
                               wire:model.live="filters.destination"
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($this->getDeviceRetrievalLogsProperty() as $log)
                        <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-5 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $log->returned_at ? $log->returned_at->format('M d, Y') : 'N/A' }}</div>
                                <div class="text-xs text-gray-500 mt-1">{{ $log->returned_at ? $log->returned_at->format('h:i A') : '' }}</div>
                            </td>
                            <td class="px-6 py-5 whitespace-nowrap">
